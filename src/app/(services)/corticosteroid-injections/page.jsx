    ...
    <div className="pt-16">
      <div>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-7 items-end">
            ...
            <p className="text-lg max-w-3xl leading-normal">{service3Data.para1}</p>
          </div>
          <div className="grid mt-12 lg:mt-24 grid-cols-2 gap-7">
            <Image src="/assets/service3/main-img-1.jpg" width={500}  height={500} alt="Service Image" style={{width: "100%", maxHeight: "441px", objectFit: "cover", borderRadius: "30px"}} />
            <Image src="/assets/service3/main-img-2.jpg" width={500}  height={500} alt="Service Image" style={{width: "100%", maxHeight: "441px", objectFit: "cover", borderRadius: "30px"}} />
          </div>
        </div>
        <div className="mt-12 lg:mt-24">
          ...
          <div className="grid grid-cols-1 gap-7 [&>*:nth-child(even)]:bg-green">
            ...
            <div className=" rounded-3xl overflow-hidden">
              <Image src="/assets/service3/main-img-3.jpg" width={400} height={400} alt="Service Image" style={{width: "100%", height: "100%" , objectFit: "cover"}} />
            </div>
          </div>
          <div>
            ...
            <div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-7 mt-12">
                <div className=" rounded-3xl overflow-hidden">
                  <Image src="/assets/service3/main-img-4.jpg" width={400} height={400} alt="Service Image" style={{width: "100%", height: "100%" , objectFit: "cover"}} />
                </div>
            ...
            <p className="text-lg max-w-3xl mt-24 leading-normal">{service3Data.para2}</p>
        </div>
      <Cta />
      <Testimonial />
      <BookAppointment />
