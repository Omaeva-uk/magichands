          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-7 items-end">
            ...
            <p className="text-lg max-w-3xl leading-normal">{service6Data.para1}</p>
              ...
              <div className="grid mt-12 lg:mt-24 grid-cols-2 auto-rows-[315px] gap-7">
                <Image src="/assets/service6/main-img-1.jpg" width={500}  height={500} alt="Service Image" style={{width: "100%", maxHeight: "100%", objectFit: "cover", borderRadius: "30px"}} />
                <Image src="/assets/service6/main-img-2.jpg" width={500}  height={500} alt="Service Image" style={{width: "100%", maxHeight: "100%", objectFit: "cover", borderRadius: "30px"}} />
              </div>
          </div>
