  ...
  return (
    <div className="pt-16">
          ...
          <div className="mt-12 lg:mt-24">
            <p className="text-xl max-w-3xl leading-normal">{service6Data.para1}</p>
            ...
            <div className="grid mt-7 grid-cols-1 lg:grid-cols-2 gap-7">
              ...
              <div className=" rounded-3xl overflow-hidden">
                  <Image src="/assets/service-img.jpg" width={500} height={500} alt="Service Image" style={{width: "100%", height: "100%" , objectFit: "cover"}} />
              </div>
            </div>
