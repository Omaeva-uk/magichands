...
const PrimaryButton = ({icon, text, width, href}) => {
  return (
    <Link href={`${href ? href : '/#appointment'} `}>
     <button className={`bg-green hover:bg-blue hover:text-white transition-all flex justify-center items-center gap-2 px-5 py-3 font-semibold rounded-xl ${width === 'full' && 'w-full'} `}>
