...
const Providers = () => {
  return (
    <div className="my-12  xl:my-24">
        <h2 className="font-raleway max-w-xl flex-1 font-semibold text-3xl my-24 leading-snug md:text-4xl md:leading-snug"><span className="text-red">Accredited</span> – Service Providers For</h2>
